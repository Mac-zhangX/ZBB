<template>
	...
	<!--<div class="middle-container" >-->
		<div class="flex-box-between record">
			<div class="record-item8">
				<ul>
					<li class="list-item jump-to">
						<div class="record-title">
							<div class="title-head">
								<img src="../../assets/img/icon/jibenxinxi.png">
								<span>基本信息</span>
							</div>
							<div class="title-btn" @click="newBuilt(0)" style="font-size: 0.14rem">
								<img src="../../assets/img/daohangxiugai.png">&nbsp;编辑
							</div>
						</div>
						<div class="nothing" v-if="block0==0">暂无任何信息</div>
						<!--新建的信息放入something里面-->
						<div class="something" v-if="block0==1">
							<ul>
								<li class="list-item">
									<el-container>
										<el-aside width="175px" class="block">
											<img src="" alt=""
										...
										<el-main>
												...
												<el-col :span="12">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">所在地区
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft">{{palce}}
														</el-col>
													</el-row>
												</el-col>
											</el-row>
											<el-row :gutter="40">
												<el-col :span="12">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">出生日期
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft Light">{{birthday}}
														</el-col>
													</el-row>
												</el-col>
												<el-col :span="12">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">手机号码
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft Light">{{mobile}}
														</el-col>
													</el-row>
												</el-col>
											</el-row>
											<el-row :gutter="40">
												<el-col :span="12">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">微信号
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft Light">{{weChart}}
														</el-col>
													</el-row>
												</el-col>
												<el-col :span="12">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">电子邮箱
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft Light">{{email}}
														</el-col>
													</el-row>
												</el-col>
											</el-row>
											<el-row :gutter="40">
												<el-col :span="12">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">求职意愿
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft Light">{{interest}}
														</el-col>
													</el-row>
												</el-col>
												<el-col :span="3" :offset="9" @click="editor1(0)">修改</el-col>
											</el-row>
										</el-main>
									</el-container>
								</li>
						...
						<!--jbxx是编辑框-->
						<div v-if="two0 == 0" class="jbxx jlTable">
							<div class="profile-edit-form">
								<el-form ref="userInfos" class="form01" :model="userInfos" :rules="personalRules"
								         label-width="80px">
										...
										<el-row :gutter="20">
											<el-col :span="12">
												<el-form-item label="姓名" prop="userFullname">
													<el-input v-model="userInfos.userFullname"></el-input>
												</el-form-item>
											</el-col>
											<el-col :span="12">
												<el-form-item label="性别" prop="userSex">
													<el-radio-group v-model="userInfos.userSex"
										...
										<el-row :gutter="20">
											<el-col :span="12">
												<el-form-item label="所在地区" prop="userRegion">
													<el-select v-model="userInfos.userRegion" autocomplete="off"
													           placeholder="请选择国家">
											...
											<el-col :span="12">
												<el-form-item label="" prop="userArea"
													...
													<el-select v-model="userInfos.userArea" placeholder="请选择求职地区">
														<el-option label="区域一" value="shanghai"></el-option>
														<el-option label="区域二" value="beijing"></el-option>
													</el-select>
												</el-form-item>
										...
										<el-row :gutter="20">
											...
											<el-col :span="12">
												<el-form-item label="手机号码" prop="userMobile">
													<el-input v-model="userInfos.userMobile"></el-input>
												</el-form-item>
											</el-col>
										</el-row>
										<el-row :gutter="20">
											<el-col :span="12">
												<el-form-item label="微信号" prop="userWex">
													<el-input v-model="userInfos.userWex"></el-input>
												</el-form-item>
											</el-col>
											<el-col :span="12">
												<el-form-item label="电子邮箱" prop="userEmail">
													<el-input v-model="userInfos.userEmail"></el-input>
												</el-form-item>
											</el-col>
										</el-row>
										<el-row :gutter="20">
											<el-col :span="24">
												<el-form-item label="求职意愿" prop="userMessage">
													<el-input type="textarea"
													          v-model="userInfos.userMessage"></el-input>
												</el-form-item>
											</el-col>
										</el-row>
										<el-row :gutter="20">
											<el-button type="primary" @click="builtForm('userInfos',0)"
											           style="padding: 12px 44px">保存
											</el-button>
											<el-button style="padding: 12px 44px"
											           @click="unBuiltForm('userInfos',0)">取消
											</el-button>
										</el-row>
									</div>
								</el-form>
					...
					<li class="list-item jump-to">
						<div class="record-title">
							...
							<div class="title-btn" @click="newBuilt(1)" style="font-size: 0.14rem">
										...
										<el-main>
											<el-row :gutter="40">
												<el-col :span="8">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">毕业学校
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft">{{item.shcool}}
														</el-col>
													</el-row>
												</el-col>
												<el-col :span="8">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">学历
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft">{{item.education}}
														</el-col>
													</el-row>
												</el-col>
												<el-col :span="8">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">所学专业
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft">{{item.professional}}
														</el-col>
													</el-row>
												</el-col>
											</el-row>
											...
											<el-row :gutter="40">
												...
												<el-col :span="3" :offset="13" @click="editor2(1)">编辑</el-col>
											</el-row>
										</el-main>
									</el-container>
								</li>
					...
					<li class="list-item jump-to">
						<div class="record-title">
							...
							<div class="title-btn" @click="newBuilt(2)" style="font-size: 0.14rem">
										...
										<el-main>
											<el-row :gutter="40">
												<el-col :span="8">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">企业名称
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft">{{item.company}}
														</el-col>
													</el-row>
												</el-col>
												<el-col :span="8">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">所属行业
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft">{{item.industry}}
														</el-col>
													</el-row>
												</el-col>
												<el-col :span="8">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">行业细分
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft">{{item.IndustrySegments}}
														</el-col>
													</el-row>
												</el-col>
											</el-row>
											...
											<el-row :gutter="40">
												...
												<el-col :span="3" :offset="5" @click="editor3(2)">编辑</el-col>
											</el-row>
										</el-main>
									</el-container>
								</li>
					...
					<li class="list-item jump-to">
						<div class="record-title">
							...
							<div class="title-btn" @click="newBuilt(3)" style="font-size: 0.14rem">
										...
										<el-main>
											<el-row :gutter="40">
												<el-col :span="8">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">项目类型
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft">{{item.type}}
														</el-col>
													</el-row>
												</el-col>
												<el-col :span="8">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">项目名称
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft">{{item.name}}
														</el-col>
													</el-row>
												</el-col>
											</el-row>
											<el-row :gutter="40">
												<el-col :span="8">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">承担角色
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft">{{item.role}}
														</el-col>
													</el-row>
												</el-col>
												<el-col :span="8">
												...
												<el-col :span="3" :offset="5" @click="editor4(3)">编辑</el-col>
											</el-row>
										</el-main>
									</el-container>
								</li>
					...
					<li class="list-item jump-to">
										...
										<el-main>
											<el-row :gutter="40">
												<el-col :span="8">
													<el-row :gutter="20">
														<el-col :span="10" style="text-align: right"
														        class="alignRight Regular">计算机技能
														</el-col>
														<el-col :span="14" style="text-align: left"
														        class="alignLeft">{{item.skillType}}
														</el-col>
													</el-row>
												</el-col>
											</el-row>
											...
											<el-row>
												...
												<el-col :span="3" :offset="13" @click="editor5(4)">编辑</el-col>
											</el-row>
										</el-main>
									</el-container>
								</li>
						...
						<div v-if="check4 == 4" class="jlTable">
							<div class="profile-edit-form">
								<el-form ref="checkRuleForm5" :model="checkRuleForm5" :rules="skillRules" label-width="80px">
									<el-row :gutter="20">
										<el-col :span="12">
											<el-form-item label="技能类型" prop="skillType">
	    ...
	    data(){
          return{
              ...
              projectRules: {
                  ...
                  result: [
                      {required: 'true', message: '请输入项目成果', trigger: 'blu  r'}
                  ],
              },
              ruleForm5: {
                  skillType: '',
